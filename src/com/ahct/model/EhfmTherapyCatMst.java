...
@Entity
@Table(name="EHFM_MAIN_CATEGORY")
public class EhfmTherapyCatMst implements java.io.Serializable{
	
	private EhfmTherapyCatMstId id;
	...
	public EhfmTherapyCatMstId getId() {
		return id;
	}

	public void setId(EhfmTherapyCatMstId id) {
		this.id = id;
	}
