...
@Entity
@Table(name="EHFM_MAIN_THERAPY")
public class EhfmTherapyProcMst implements java.io.Serializable{

	private EhfmTherapyProcMstId id;
	...
	public EhfmTherapyProcMstId getId() {
		return id;
	}
	public void setId(EhfmTherapyProcMstId id) {
		this.id = id;
	}
	...
	public EhfmTherapyProcMst() {
		super();
	}
	
	
	public EhfmTherapyProcMst(EhfmTherapyProcMstId id, String procName,
