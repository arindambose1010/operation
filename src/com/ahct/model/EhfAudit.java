...
@Entity
@Table(name = "EHF_AUDIT")
public class EhfAudit implements Serializable {

	private EhfAuditId id;
    ...
    @AttributeOverrides( {
        ...
        @AttributeOverride(name="caseId", column=@Column(name="CASE_ID", nullable=false, length=5) ) } )
public EhfAuditId getId() {
        return id;
}
public void setId(EhfAuditId id) {
        this.id = id;
}
@Column(name="ACT_BY")
