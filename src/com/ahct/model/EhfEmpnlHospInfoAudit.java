...
@Entity
@Table
( name = "EHF_EMPNL_HOSPINFO_AUDIT" )
public class EhfEmpnlHospInfoAudit implements Serializable{
    /**
	 * 
	 */
   ...
   public String getState() {
    ...
    @SequenceGenerator(name="pk_seq", sequenceName="ASRIT_EMPNL_HOSPINFO_AUDIT_SEQ")
