...
@Entity
@Table(name = "ehf_claim_tds_payment")

public class EhfClaimTdsPayment implements Serializable{
    ...
    public void setCaseFllwUpId(String caseFllwUpId) {
        this.caseFllwUpId = caseFllwUpId;
    }

    @Column(name="CASE_FOLLOWUP_ID", length=15)
    public String getCaseFllwUpId() {
        return caseFllwUpId;
    }
