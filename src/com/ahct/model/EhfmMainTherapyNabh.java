...
@Entity
@Table(name="EHFM_MAIN_THERAPY_NABH")
public class EhfmMainTherapyNabh implements java.io.Serializable{

	private EhfmMainTherapyNabhId id;
	...
	public EhfmMainTherapyNabhId getId() {
		return id;
	}
	public void setId(EhfmMainTherapyNabhId id) {
		this.id = id;
	}
	...
	public EhfmMainTherapyNabh() {
		super();
	}
	
	
	public EhfmMainTherapyNabh(EhfmMainTherapyNabhId id, String procName,
