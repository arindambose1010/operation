...
@Entity
@Table(name = "EHF_OPD_CLAIM_AUDIT")
public class EhfOpdClaimAudit {
    @EmbeddedId
    private EhfOpdClaimAuditPK id;
	//Chandana - 7845 - For patient id
    ...
    //Chandana - 8036 - Added the below
    @Column(name = "CLAIM_AMOUNT")
    private Double claimAmount;
    
    //Chandana - 8602 - New column to store user role
    @Column(name = "USER_ROLE")
    private String userRole;

    // Getters and Setters
    public EhfOpdClaimAuditPK getId() {
        return id;
    }
    public void setId(EhfOpdClaimAuditPK id) {
        this.id = id;
    }
