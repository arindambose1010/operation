...
/**
 * The primary key class for the EHF_CHRONIC_CASE_DTLS database table.
 * 
 */
@Embeddable
public class EhfChronicCaseDtlPK implements Serializable {
	//default serial version id, required for serializable classes.
	private static final long serialVersionUID = 1L;
	private String chronicId;
	private String chronicNo;

    public EhfChronicCaseDtlPK() {
    }
	...
	public EhfChronicCaseDtlPK(String chronicId, String chronicNo) {
		super();
		this.chronicId = chronicId;
		this.chronicNo = chronicNo;
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof EhfChronicCaseDtlPK)) {
			return false;
		}
		EhfChronicCaseDtlPK castOther = (EhfChronicCaseDtlPK)other;
		return 
