...
public class EhfmHubSpokeMainTherapyId implements java.io.Serializable{
	...
	public EhfmHubSpokeMainTherapyId(String hubHospId,String asriCode, String icdProcCode, String state, String process) {
		super();
		this.hubHospId = hubHospId;
		this.asriCode = asriCode;
		this.icdProcCode = icdProcCode;
	...
	public EhfmHubSpokeMainTherapyId() {
		super();
	}
	@Override
	public int hashCode() {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		EhfmHubSpokeMainTherapyId other = (EhfmHubSpokeMainTherapyId) obj;
		if (asriCode == null) {
