...
@Entity
@Table(name="EHF_PNLDOC_TDS_AUDIT")
public class EhfPnldocTdsAudit implements Serializable{

    private EhfPnldocTdsAuditId id;
	...
	public void setId(EhfPnldocTdsAuditId id) {
        this.id = id;
    }
    ...
    public EhfPnldocTdsAuditId getId() {
        return id;
    }
