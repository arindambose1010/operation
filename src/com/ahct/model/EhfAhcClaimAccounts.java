...
@Entity
@Table(name="EHF_AHC_CLAIM_ACCOUNTS"
)
public class EhfAhcClaimAccounts  implements java.io.Serializable{

	private Long aprvdAmt;
	...
	public Long getAprvdAmt() {
		return aprvdAmt;
	}
	public void setAprvdAmt(Long aprvdAmt) {
