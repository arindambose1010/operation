...
@Entity
@Table(name = "EHF_FOLLOWUP_DOC_ATTCH")
public class EhfFollowupDocAttch implements java.io.Serializable  {
    ...
    @Column(name = "followup_id", unique = true, nullable = false, length = 20)  
