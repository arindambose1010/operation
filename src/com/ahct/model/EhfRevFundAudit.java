...
@Entity
@Table(name="EHF_RevFund_AUDIT")
public class EhfRevFundAudit implements Serializable {

	private EhfRevFundAuditId id;
    ...
    public void setId(EhfRevFundAuditId id) {
        this.id = id;
    }

    @EmbeddedId 
    @AttributeOverrides( {
        @AttributeOverride(name="rfPaymentId", column=@Column(name="RF_PAYMENT_ID",nullable=false,length=25)),
        @AttributeOverride(name="actOrder",column=@Column(name="ACT_ORDER",nullable=false,length=10 ))
    }
    ) 
    public EhfRevFundAuditId getId() {
        return id;
    }
