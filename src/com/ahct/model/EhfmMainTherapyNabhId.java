...
public class EhfmMainTherapyNabhId implements java.io.Serializable{
...
public EhfmMainTherapyNabhId(String asriCode, String icdProcCode, String state, String process) {
	super();
	this.asriCode = asriCode;
	this.icdProcCode = icdProcCode;
	this.state = state;
...
public boolean equals(Object obj) {
	...
	if (getClass() != obj.getClass())
		return false;
	EhfmMainTherapyNabhId other = (EhfmMainTherapyNabhId) obj;
	if (asriCode == null) {
