...
@Entity
@Table(name = "EHFM_DIA_SUBCAT_MST")
public class EhfmDiagSubCatMst implements Serializable {

	private EhfmDiagSubCatMstId id;
	...
	public EhfmDiagSubCatMstId getId() {
		return id;
	}

	public void setId(EhfmDiagSubCatMstId id) {
		this.id = id;
	}
	...
	public EhfmDiagSubCatMst(EhfmDiagSubCatMstId id, String subCatName,
