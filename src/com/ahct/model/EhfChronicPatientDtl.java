...
/**
 * The persistent class for the EHF_CHRONIC_PATIENT_DTLS database table.
 * 
 */
@Entity
@Table(name="EHF_CHRONIC_PATIENT_DTLS")
public class EhfChronicPatientDtl implements Serializable {
