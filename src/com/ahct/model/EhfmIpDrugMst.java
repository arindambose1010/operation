...
@Entity
@Table(name="EHFM_IP_DRUG_MST")
public class EhfmIpDrugMst implements Serializable{
	...
	public EhfmIpDrugMst() {
		super();
		// TODO Auto-generated constructor stub
	}
	
	
	public EhfmIpDrugMst(String mainGrpCode, String mainGrpName,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		EhfmIpDrugMst other = (EhfmIpDrugMst) obj;
		if (activeYN == null) {
