...
private long totAttach;
private Long chronicAttch;
private Number PKGAMOUNT;
...
public long getTotAttach() {
	return totAttach;
}
public void setTotAttach(long totAttach) {
	this.totAttach = totAttach;
}
public Long getChronicAttch() {
	return chronicAttch;
}
public void setChronicAttch(Long chronicAttch) {
	this.chronicAttch = chronicAttch;
}


public Number getPKGAMOUNT() {
	return PKGAMOUNT;
}
public void setPKGAMOUNT(Number pKGAMOUNT) {
	PKGAMOUNT = pKGAMOUNT;
}
...
public String getPrefAbhaAddr() {
	return prefAbhaAddr;
}
public void setPrefAbhaAddr(String prefAbhaAddr) {
	this.prefAbhaAddr = prefAbhaAddr;
}
