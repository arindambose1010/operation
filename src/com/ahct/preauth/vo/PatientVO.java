...
private String collectorCertNo;
private String tapIdProof;
private String tapIdProofNo;
private String collectorCertNo2;
...
public String getCollectorCertNo() {
	return collectorCertNo;
}
public void setCollectorCertNo(String collectorCertNo) {
	this.collectorCertNo = collectorCertNo;
}
public String getTapIdProof() {
	return tapIdProof;
}
public void setTapIdProof(String tapIdProof) {
	this.tapIdProof = tapIdProof;
}
public String getTapIdProofNo() {
	return tapIdProofNo;
}
public void setTapIdProofNo(String tapIdProofNo) {
	this.tapIdProofNo = tapIdProofNo;
}
public String getCollectorCertNo2() {
	return collectorCertNo2;
}
public void setCollectorCertNo2(String collectorCertNo2) {
	this.collectorCertNo2 = collectorCertNo2;
}
