		...
		<tr><td>
		   <table width="100%">
		      ...
		      <tr>
		      	...
		      	<td width="30%" class="tbcellBorder print_cell"><bean:write name="patientForm" property="complaints" /></td>
		      </tr>
		      	<tr>
		...
		<tr><td class="tbcellCss"><span class="labelheading1"><strong>i) Drug details</strong></span>
		  ...
		  <tr>
			<td style="width:5%;word-wrap:break-word;" class="tbheader1 print_cell"><strong>Sr. No.</strong></td>
							...
							<c:if test="${schemeId eq 'CD202'}">
								<c:if test ="${regHospId ne 'EHS34' }">
									<td style="width:25%;word-wrap:break-word;" class="tbheader1 print_cell"><strong>Chemical Substance Name</strong></td>
									<td style="width:15%;word-wrap:break-word;" class="tbheader1 print_cell"><strong>Route Type</strong></td>
		
									<td style="width:10%;word-wrap:break-word;" class="tbheader1 print_cell"><strong>Strength</strong></td>
									<td style="width:20%;word-wrap:break-word;" class="tbheader1 print_cell"><strong>Dosage(per day)</strong></td>
									<td style="width:25%;word-wrap:break-word;" class="tbheader1 print_cell"><strong>Medication Period(Days)</strong></td>
								</c:if>
								<c:if test ="${regHospId eq 'EHS34' }">
									<td style="width:95%;word-wrap:break-word;" class="tbheader1 print_cell"><strong>Drug Details</strong></td>
								</c:if>	
							</c:if>
						...
						<logic:iterate id="drugs" name="patientForm" property="drugLt">
							<tr>
								...
								<c:if test="${schemeId eq 'CD202'}">
									...
									<c:if test ="${regHospId eq 'EHS34' }">
										<td style="width:95%;word-wrap:break-word;" class="tbcellBorder  print_cell">${drugs.DRUGNAME}</td>
									</c:if>
								</c:if>
							</tr>
				...
				<td  colspan="5" width="100%"  align="center" class="labelheading1 tbcellCss print_cell"><b>Drugs Not Found</b></td>
