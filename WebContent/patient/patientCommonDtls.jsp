...
<td width="34%" class="tbcellBorder">${patCommonDtls.HOSPNAME}</td>
 ...
 <c:if test="${patCommonDtls.relation ne null }"><c:if test="${patCommonDtls.relation eq 'New Born Baby'}"><tr><td width="10%" class="labelheading1 tbcellCss"><b>Patient Type</b></td><td width="20%" class="tbcellBorder"><b>${patCommonDtls.relation}</b></td></tr></c:if></c:if>
 ...
 <img src="common/showDocument.jsp" width="110" height="90" alt="NO DATA"  id="patImage" 
  onmouseover="javascript:resizePatImage('patImage','120','100')" onmouseout="resizePatImage('patImage','110','90')" />
 </c:when>
  <c:otherwise>
