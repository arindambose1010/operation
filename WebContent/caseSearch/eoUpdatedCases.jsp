...
{
	document.forms[0].action = '/Operations/casesSearchAction.do?actionFlag=eoUpdatedCases&pageNo='+pageNo+'&rowsPerPage='+rowsPerPage+'&dmeFlag=N';
	document.forms[0].submit();
}

function fn_preauthDetails(caseId,patientId)
{	
	 var url1="/Operations/casesSearchAction.do?actionFlag=preauthDetailsDME&UpdType=ehfPreauth&caseId="+caseId+"&patientId="+patientId+"&eoFlag=Y";
...
<body onload="fn_success()">
	<html:form    action="/casesSearchAction.do" enctype="multipart/form-data" method="post">
		<div class="container-fluid">
			<div class="tbheader"><b>Aarogyasri Healthcare Trust Updated Cases</b></div> 
			<div>	
					...
					<table  cellpadding="1" cellspacing="1" align="center" style="padding-top:0px;margin:0px auto;" class="tb">
						<tr>
						 ...
						 <tr>
							...
							<td  class="tbcellBorder" style="word-wrap:break-word;padding:3px;">
								<logic:equal name="preauthCaseSearch" property="CASESTATUS" value="Y">
									Query raised by DME to Aarogyasri Healthcare Trust
								</logic:equal>
								<logic:equal name="preauthCaseSearch" property="CASESTATUS" value="N">
									Query updated by Aarogyasri Healthcare Trust
								</logic:equal>
