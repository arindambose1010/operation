...
{
	window.open('./annualCheckUpAction.do?actionFlag=printPatientDetails&patientId='+patientId+'&pageType=print','PatientRegPrintPage','left=50,top=50,width=1000,height=600,toolbar=no,resize=no,scrollbars=yes');
}
...
<logic:notEmpty name="annualCheckUpForm" property="patientNo">
Patient Registered Successfully for Annual Health CheckUp with Patient ID : <b><bean:write name="annualCheckUpForm" property="patientNo"/></b><br><br><br>
<button class="but"  type="button" id="generatePrintPage" onclick="javascript:generatePrint('<bean:write name="annualCheckUpForm" property="patientNo"/>')">PRINT</button>
</logic:notEmpty>
<%-- <logic:notEmpty name="annualCheckUpForm" property="caseId">
<b><bean:write name="annualCheckUpForm" property="patientType"/></b> <bean:write name="annualCheckUpForm" property="msg"/> <b><bean:write name="annualCheckUpForm" property="caseId"/></b><br><br><br>
...
<center><font size="3"><bean:write name="annualCheckUpForm" property="errMsg"/></font></center>
<html:hidden name="annualCheckUpForm" property="patientNo" styleId="patientNo"/>
<html:hidden name="annualCheckUpForm" property="caseId" styleId="caseId"/>
