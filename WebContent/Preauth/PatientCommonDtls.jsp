...
var caseId = '${caseId}';
var pastHistClicked='';
var caseSheetClicked='';
var attachmentsClicked='';
var casesheetAttachClick='N';
var preauthClicked='';
var dentalFlg=parent.dentalFlg;
var loggedInRole='${loggedInRole}';
var ClaimPage='${ClaimPage}';
var cardNo='${patCommonDtls.CARDNO}';
/* sai krishna:#CR8566:for dialysis cycles view */
var speciality='${speciality}';
function viewTelephonicInfo(telephonicId){
	window.open('/Operations/patientDetails.do?actionFlag=ViewTelephonicDtls&telephonicId='+telephonicId,'','scrollbars=1,left=20,top=20,width=1000,height=650');
}
function CasesView()  
{	
...
function fn_showQuestionnaire(caseId){
	
	
	var url='/Operations/medicalAudit.do?actionFlag=getQuestionnaire&caseId='+caseId+'&purpose=show';      
	   document.forms[0].action=url;   
	   document.forms[0].target="bottomFrame";
	   document.forms[0].submit();	
}

function fn_viewQuestionnaire(caseId,fromPage){
	
	
	var url='/Operations/medicalAudit.do?actionFlag=getQuestionnaire&caseId='+caseId+'&purpose=view&fromPage='+fromPage;       
	   document.forms[0].action=url;   
	   document.forms[0].target="bottomFrame";
	   document.forms[0].submit();	
}
function fn_PastData()
{
   ...
   var url="/Operations/casesApprovalAction.do?actionFlag=getPastHistory&employeeNo=${patCommonDtls.EMPLOYEENO}&fromPastHistory=Y&caseId=${caseId}";
   document.forms[0].action=url;   
   document.forms[0].target="bottomFrame";
   document.forms[0].submit();	
}
function fn_newUser()
{
	var url="/Operations/casesApprovalAction.do?actionFlag=getnewUser&patientId=${patCommonDtls.PATID}&cardNo=${patCommonDtls.CARDNO}&caseId=${caseId}&employeeNo=${patCommonDtls.EMPLOYEENO}&fromPastHistory=Y";
	 document.forms[0].action=url;   
	 document.forms[0].target="bottomFrame";
	 document.forms[0].submit();	
}
...
{
	var url="/Operations/preauthDetails.do?actionFlag=getOnlineCaseSheet&caseId=${caseId}&patientId=${patCommonDtls.PATID}&caseSheetFlag="+caseSheetFlag+"&dentalFlg="+dentalFlg;;      
	   document.forms[0].action=url;   
	  // alert(url);
	   document.forms[0].target="bottomFrame";
	   document.forms[0].submit();	
...
{	
	if(parent.ipRefershFlag != null && parent.ipRefershFlag !='' && parent.ipRefershFlag=='Y')
		...
		{
   var url="/Operations/patCommonDtls.htm?actionFlag=getPatDetails&CaseId=${patCommonDtls.CASEID}&PatientID=${patCommonDtls.PATID}&speciality=${speciality}";   
   document.forms[0].action=url;   
   document.forms[0].target="bottomFrame";
   document.forms[0].submit();
		}
...
<body onload="javascript:fn_getIP();">
