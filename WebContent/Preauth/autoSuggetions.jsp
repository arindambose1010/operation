...
<link href="css/themes/<%=themeColour%>/commonEhfCss.css" rel="stylesheet" type="text/css" media="screen">
		 <script src="/Operations/Preauth/autoComplete/jquery.js"></script> 
	<script src="/Operations/Preauth/autoComplete/jquery-ui-autocomplete.js"></script> 
	 <script src="/Operations/Preauth/autoComplete/jquery.select-to-autocomplete.min.js"></script>
...
function fn_getICDCatList()
{
	...
	else
	{
	 ...
	 url = '/<%=context%>/preauthDetails.do?actionFlag=getIcdCatList&catId='+document.forms[0].category.value;
		    	 ...
		    	 var resultArray=xmlhttp.responseText;
		            ...
		            {   
						if(document.forms[0].icdCatCode.options!=null){  
						 ...
						 $(function(){
						    	$("#icdCatCode").selectToAutocomplete();
						      $('form').submit(function(){
						        alert( $(this).serialize() );
						        return false;
						      });
...
<tr><td width="50%">&nbsp; Category Name: <font color="red">*</font></td><td width="50%">ICD Category Name : <font color="red">*</font></td></tr>
 <tr><td>&nbsp;<html:select  name="preauthDetailsForm" property="category"  styleId="category" style="width:400px;" onchange="javascript:fn_getICDCatList()">
<option  value="-1">----Select----</option>
<html:options collection="catList" property="ID" labelProperty="VALUE"  />
</html:select></td>
<td align="left" style="width:420px;">
&nbsp;<html:select   name="preauthDetailsForm" property="icdCatCode"  styleId="icdCatCode" style="width:400px;" >
